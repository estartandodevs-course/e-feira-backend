...
router.get("/api/products/provider/:provider_id",ProductController.GetAllProductsFromAProvider);
router.get("/api/products/category/:category_id",ProductController.GetAllProductsFromACategory);
